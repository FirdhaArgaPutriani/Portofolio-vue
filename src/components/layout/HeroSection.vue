    ...
    <section class="flex justify-center items-center dark:text-white min-h-screen mt-20 lg:mt-0">
        ...
        <main class="absolute grid lg:grid-cols-2 grid-cols-1 items-center p-2 lg:p-8">
            ...
            <aside class="container flex justify-center lg:justify-end mt-20 lg:mt-0 items-center flex-wrap">
                <figure class="card relative m-[30px] md:w-[420px] md:h-[420px] md:before:h-[450px] w-[280px]
                h-[350ox] before:w-[300px] before:h-[300px] before:border-[25px] before:border-primary 
                before:shadow-[7px_7px_secondary,_-7px_-7px_21px_secondary]">
                    <div class="relative w-full h-full bg-cover transform translate-x-[10px] translate-y-[10px]">
                        <img src="@/assets/images/ME.png" alt="Hero picture" class="max-w-1/2" loading="lazy">
                    </div>
                </figure>
            </aside>
        </main>
