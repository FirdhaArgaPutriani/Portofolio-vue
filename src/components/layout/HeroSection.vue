<template>
    <section data-aos="zoom-in" class="flex justify-center items-center dark:text-white min-h-screen mt-20 lg:mt-0">
        ...
        <header class="absolute w-1/2 aspect-[16/5] -skew-x-12 rounded-full bg-gradient-to-r from-[#00C6CC]
        via-[#785AE4] to-secondary opacity-30 dark:opacity-20 blur-[100px] right-10 bottom-0 hidden md:block">
        ...
        <main class="absolute grid lg:grid-cols-2 grid-cols-1 items-center p-2 lg:p-8">
            <header class="text-center lg:text-left">
                ...
                <p class="text-lg max-w-xl mx-auto lg:mx-0 font-semibold">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam ipsa eaque placeat quod consequatur
                    nemo officia sed deserunt accusamus quis hic, nisi possimus minima amet pariatur ad. Doloribus,
                    a molestias.
                </p>
                <div class="mt-6 flex justify-center lg:justify-start">
                    <Button label="Hire Me" />
                    <a href="" class="font-semibold text-lg w-[10rem] h-[55px] dark:text-secondary rounded-full
                    ml-2 border-2 dark:border-secondary hover:scale-105 bg-white dark:bg-transparent
                    flex justify-center items-center text-primary border-primary">
                        <Icon icon="line-md:download-loop" class="text-3x1" />
            ...
            <aside class="container flex justify-center lg:justify-end mt-20 lg:mt-0 items-center flex-wrap">
                <figure
                    class="card relative m-[30px] md:w-[420px] md:h-[420px] md:before:w-[430px] md:before:h-[430px] w-[250px] h-[350px] before:w-[300px] before:h-[300px]
                before:border-[25px] before:border-primary before:shadow-[7px_7px_21px_primary,_-7px,_-7px_21px_primary] dark:before:border-secondary dark:before:shadow-[7px_7px_21px_secondary,_-7px,_-7px_21px_secondary]"> 
                    <div class="relative w-full h-full bg-cover transform translate-x-[10px] translate-y-[10px]">
                        <img src="@/assets/images/miaw.png" alt="Hero picture" class="max-w-1/2" loading="lazy">
                    </div>
                </figure>
            </aside>
        </main>
